...
offerings:
  ...
  - title: "Recours devant le TAQ"
    description: "On prépare et dépose votre dossier devant le Tribunal administratif du Québec pour maximiser vos chances de succès."
  - title: "Représentation devant les tribunaux administratifs"
    description: "On plaide votre cause avec rigueur pour que votre version des faits soit entendue et prise au sérieux."
  - title: "Contestation CNESST, SAAQ et organismes publics"
    description: "On conteste les décisions qui ne reflètent pas votre réalité pour obtenir les indemnités ou les droits auxquels vous avez droit."
  - title: "Demandes de révision"
    description: "On dépose vos demandes de réexamen dans les délais pour rouvrir un dossier qu'on pensait fermé."
  - title: "Négociation hors audience"
    description: "On négocie directement avec l'organisme pour régler votre dossier plus rapidement, sans passer par une audience."
  - title: "Enquêtes et inspections administratives"
...
faq:
  ...
  - question: "Ai-je besoin d'un avocat pour un recours administratif?"
    answer: "<p>Techniquement, vous pouvez vous représenter seul devant un tribunal administratif. Cependant, les procédures peuvent être complexes et les enjeux importants. Un avocat spécialisé connaît les règles de preuve, les délais à respecter et les arguments qui portent. Chez AUDEX, on vous accompagne à chaque étape pour maximiser vos chances de succès, tout en vous expliquant clairement ce qui se passe.</p>"
  - question: "Quels sont les délais pour contester une décision administrative?"
    answer: "<p>Les délais varient selon le type de décision et l'organisme concerné, mais ils sont souvent de 30 à 60 jours à compter de la réception de la décision. Passé ce délai, vous pourriez perdre votre droit de contestation. C'est pourquoi il est essentiel de consulter un avocat dès que vous recevez une décision qui vous semble injuste. Chez AUDEX, on peut rapidement évaluer votre situation et agir dans les temps.</p>"
  - question: "Combien coûte un avocat en droit administratif au Québec?"
    answer: "<p>Les honoraires varient selon la complexité du dossier. Chez AUDEX, nous offrons une première consultation à tarif fixe, ce qui vous permet de comprendre votre situation et vos options sans surprise. On vous explique ensuite les coûts prévisibles pour la suite de votre dossier, en toute transparence. Appelez-nous au 418-462-1010 pour en discuter.</p>"
ctaText: "Discutez de votre recours administratif avec un avocat"
relatedServices:
  - droit-municipal
  - droit-civil-general
